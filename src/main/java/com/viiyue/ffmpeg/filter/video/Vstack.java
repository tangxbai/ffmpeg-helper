 ...
 */
@Function( "vmafmotion" )
public class Vstack extends AbstractFunction<Vstack> {
	...
	/**
	 * <p>
	 * Quickly create an instances of {@link Vstack}
	 * 
	 * <p>
	 ...
	 * @return the {@link Vstack} instance
	 */
	public static final Vstack of( String file ) {
		return new Vstack().addArg( "stats_file", file );
	}
