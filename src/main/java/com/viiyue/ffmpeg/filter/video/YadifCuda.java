 ...
 * @author tangxbai
 * @since 2022/10/21
 * @see <a href="https://ffmpeg.org/ffmpeg-filters.html#yadif_005fcuda">ffmpeg-filters#yadif_cuda</a>
 */
@Function( "yadif_cuda" )
public class YadifCuda extends AbstractFunction<YadifCuda> {

	// Don't let anyone instantiate this class
	private YadifCuda() {}

	/**
	 * Quickly create an instances of {@link YadifCuda}
	 * 
	 * @return the {@link YadifCuda} instance
	 */
	public static final YadifCuda of() {
		return new YadifCuda();
	}
	 ...
	 * @see InterlacingMode
	 */
	public YadifCuda mode( InterlacingMode mode ) {
	 ...
	 * @see Parity
	 */
	public YadifCuda parity( Parity parity ) {
	 ...
	 * @see Deinterlace
	 */
	public YadifCuda deint( Deinterlace deint ) {
