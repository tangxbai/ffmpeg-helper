 ...
 * @author tangxbai
 * @since 2022/06/10
 * @see <a href="https://ffmpeg.org/ffmpeg-filters.html#blend-1">ffmpeg-filters#blend</a>
 */
@Function( "blend" )
public class Blend extends AbstractFunction<Blend> {

	// Don't let anyone instantiate this class
	private Blend() {}

	/**
	 * Quickly create an instances of {@link Blend}
	 * 
	 * @return the {@link Blend} instance
	 */
	public static final Blend the() {
		return new Blend();
	}
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c0mode( ComponentMode mode ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c1mode( ComponentMode mode ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c2mode( ComponentMode mode ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c3mode( ComponentMode mode ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend allMode( ComponentMode mode ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c0opacity( double opacity ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c1opacity( double opacity ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c2opacity( double opacity ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c3opacity( double opacity ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend allOpacity( double opacity ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c0expr( String expression ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c1expr( String expression ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c2expr( String expression ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend c3expr( String expression ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend allExpr( String expression ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend action( EofAction action ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend shortest( boolean state ) {
	 ...
	 * @return the {@link Blend} instance
	 */
	public Blend repeatLast( boolean state ) {
		return super.status( "repeatlast", state );
	}

	/**
	 * Set blend mode for specific pixel component or all pixel components in case of all_mode
	 *
	 * @author tangxbai
	 * @since 2022/06/10
	 * @see <a href="https://ffmpeg.org/ffmpeg-filters.html#blend-1">ffmpeg-filters#blend</a>
	 */
	public enum ComponentMode implements AbstractEnum {

		NORMAL( "normal" ), AND( "and" ), OR( "or" ), XOR( "xor" ), DIVIDE( "divide" ), SUBTRACT( "subtract" ),
		ADDITION( "addition" ), MULTIPLY( "multiply" ), MULTIPLY_128( "multiply128" ), AVERAGE( "average" ),

		GLOW( "glow" ), BLEACH( "bleach" ), BURN( "burn" ), DODGE( "dodge" ), EXCLUSION( "exclusion" ),
		EXTREMITY( "extremity" ), FREEZE( "freeze" ), GEOMETRIC( "geometric" ),

		GRAIN_EXTRACT( "grainextract" ), GRAIN_MERGE( "grainmerge" ),

		HARD_LIGHT( "hardlight" ), LINEAR_LIGHT( "linearlight" ), PIN_LIGHT( "pinlight" ), SOFT_LIGHT( "softlight" ),
		VIVID_LIGHT( "vividlight" ),

		HARD_MIX( "hardmix" ), HARD_OVERLAY( "hardoverlay" ),

		DARKEN( "darken" ), LIGHTEN( "lighten" ),

		HEAT( "heat" ), HARMONIC( "harmonic" ), INTERPOLATE( "interpolate" ), NEGATION( "negation" ),
		OVERLAY( "overlay" ), PHOENIX( "phoenix" ), REFLECT( "reflect" ), SCREEN( "screen" ), STAIN( "stain" ),

		DIFFERENCE( "difference" ), SOFT_DIFFERENCE( "softdifference" );

		private String command;

		private ComponentMode( String mode ) {
			this.command = mode;
		}
