 ...
 * @author tangxbai
 * @since 2022/08/03
 * @see <a href="https://ffmpeg.org/ffmpeg-filters.html#setdar_002c-setsar">ffmpeg-filters#setsar</a>
 */
@Function( "setsar" )
public class SetSar extends AbstractFunction<SetSar> {

	// Don't let anyone instantiate this class
	private SetSar() {}

	/**
	 * Quickly create an instances of {@link SetSar}
	 * 
	 * @return the {@link SetSar} instance
	 */
	public static final SetSar of() {
		return new SetSar();
	}
	 ...
	 * @return the {@link SetSar} instance
	 */
	public SetSar sar( double ratio ) {
		return super.addArg( "sar", ratio );
	}
	 ...
	 * @return the {@link SetSar} instance
	 */
	public SetSar sar( int num, int den ) {
		return super.addArg( "sar", num + "/" + den );
	}
	 ...
	 * @return the {@link SetSar} instance
	 */
	public SetSar ratio( double ratio ) {
	 ...
	 * @return the {@link SetSar} instance
	 */
	public SetSar ratio( int num, int den ) {
